...
#define CTL_GR RALT(RALT(KC_Q))
#define CTL_Q RALT(RALT(KC_Q))
#define CTL_A RALT(RALT(KC_A))
#define CTL_O RALT(RALT(KC_O))
...
[QWERTY_] = LAYOUT_preonic_1x2uC( \
  ...
  CTL_GR,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
  KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_APP,
  KC_LSFT, KC_LGUI, KC_RGUI, KC_LALT, L_NUM,       KC_SPC,       L_MOVE,  KC_RALT, XXXXXXX, L_FUNC,  KC_RSFT),
...
[MOVE_] = LAYOUT_preonic_1x2uC(
  ...
  _______, XXXXXXX, CTL_Q,   CTL_O,   CTL_A,   XXXXXXX, XXXXXXX, KC_HOME, KC_UP,   KC_END,  XXXXXXX, KC_DEL,
